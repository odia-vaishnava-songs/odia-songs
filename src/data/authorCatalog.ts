...
export const AUTHOR_CATALOG: AuthorCatalog[] = [
    {
        ...
        odia: 'ଶ୍ରୀଲ ଭକ�        catalog: [
            ...
            { title_english: "Boro Sukher Khabar Gai" },
            { title_english: "Dekhite Dekhite" },
            { title_english: "Doyal Nitai Caitanya" },
            ...
            { title_english: "Gurudeva Krpa Bindu Diya" },
            { title_english: "Gurudeva! Boro Krpa Kori" },
            { title_english: "Gurudeve Vraja Vane Vraja Bhumi" },
            { title_english: "Hari bolo Hari bolo" },
            { title_english: "Hari Hari Kabe Mora Hobe Heno Dina" },
            ...
            { title_english: "Kabe Gaura Vane" },
            { title_english: "Kabe Habe Bolo" },
            { title_english: "Kabe Habe Heno Dasa Mor" },
            { title_english: "Kabe Mui Vaisnava Cinibo" },
            { title_english: "Kabe Sri Caitanya More Koribena Doya" },
            ...
            { title_english: "Krpa Koro Vaisnava Thakura" },
            ...
            { title_english: "Nitai Ki Nam Eneche Re" },
            ...
            { title_english: "Radha Krsna Bol Bol", title_odia: "ରାଧା-କୃଷ୍ଣ ବୋଲ ବୋଲ" },
            { title_english: "Radha Kunda Tata Kunja Kutir", title_odia: "ରାଧା-କୁଣ୍ଡ-ତଟ-କୁଞ୍ଜ-କୁଟୀର" },
            { title_english: "Ramani Siromani" },
            ...
            { title_english: "Tumi To Maribe Jare" },
            { title_english: "Tuwa Pade E Minoti Mor" },
            { title_english: "Udilo Aruna", title_odia: "ଉଦିଲ ଅରୁଣ ପୂରବ ଭାଗେ" },
