...
// Correct Supabase config from your .env
...
async function checkUser() {
  console.log("Checking User: 9937327244...");
  ...
  if (!profiles || profiles.length === 0) {
    // Try matching by phone field if it exists
    ...
    console.log("No profile found for 9937327244.");
    return;
  }
