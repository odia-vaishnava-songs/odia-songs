...
const songData = JSON.parse(fs.readFileSync(path.join(__dirname, '../radhikastakam_structured.json'), 'utf8'));
...
async function syncSong() {
    console.log('🔄 Syncing Radhikastakam to Supabase...');
    ...
    if (error) {
        ...
        console.log('✅ Radhikastakam synced successfully to Supabase!');
    }
}
