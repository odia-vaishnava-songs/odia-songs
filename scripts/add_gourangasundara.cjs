...
async function addGourangaSundara() {
  ...
  "verses": [
    ...
    },
    {
      ...
      "wordMeanings": [
        ...
        { "word": "ଅବତରି", "meaning": "ଅବତାର ଗ୍ରହଣ କରି" }
      ]
    }
  ]
};
    ...
    if (error) {
        ...
        console.log('✅ Successfully added Gouranga Sundara to Supabase!');
    }
}
