...
const songData = JSON.parse(fs.readFileSync(path.join(__dirname, '../sikshashtakam_structured.json'), 'utf8'));
...
async function syncSong() {
    console.log('🔄 Syncing Sikshashtakam to Supabase...');
    ...
    if (error) {
        ...
        console.log('✅ Sikshashtakam synced successfully to Supabase!');
    }
}
